...
use Enlightn\Enlightn\Analyzers\Performance\OpcacheAnalyzer;
...
use Enlightn\Enlightn\Analyzers\Security\PHPIniAnalyzer;
...
return [
    ...
    */
    ...
    'exclude_analyzers' => [
        OpcacheAnalyzer::class,
        CustomErrorPageAnalyzer::class,
        StableDependencyAnalyzer::class,
        FilePermissionsAnalyzer::class,
        PHPIniAnalyzer::class,
        XSSAnalyzer::class,
        InvalidPropertyAccessAnalyzer::class,
        InvalidMethodCallAnalyzer::class,
        FillableForeignKeyAnalyzer::class,
        InvalidReturnTypeAnalyzer::class,
        DeprecatedCodeAnalyzer::class,
    ],

    // If you wish to skip running some analyzers in CI mode, list the classes below.
    'ci_mode_exclude_analyzers' => [
        CacheDriverAnalyzer::class,
        QueueDriverAnalyzer::class,
        SessionDriverAnalyzer::class,
        EnvFileAnalyzer::class,
